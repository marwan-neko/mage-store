...
<html>
  ...
  <!-- Facebook and Twitter integration -->
	...
	<div id="page">
		...
		$sqlInsert = "SELECT * FROM member WHERE memberID = '$_SESSION[userID]'";
				...
				<div class="row">					
					<div class="col-md-10 col-md-offset-1">
						<div class="contact-wrap">
							<h3>Profile</h3>
							<form name="updateForm" action="updateMemberProcess.php" method="post">
								<div class="row form-group">
									<div class="col-md-7 padding-bottom">
										<label for="subject">Username</label>
										<input type="text" name="updateUsername" class="form-control" value="<?php echo $row["memberUsername"];?>" disabled>
										<br>
										<h5 style="color: red">*Not Changeable</h5>
									</div>
								</div>
								<div class="row form-group">
									<div class="col-md-6">
										<label for="fname">Full Name</label>
										<input type="text" name="updateName" class="form-control" value="<?php echo $row["memberName"];?>">
									</div>
								</div>								
								<div class="row form-group">
									<div class="col-md-4">
										<label for="email">Email</label>
										<input type="text" name="updateEmail" class="form-control" value="<?php echo $row["memberEmail"];?>">
									</div>
								</div>
								<div class="row form-group">
									<div class="col-md-4">
										<label for="subject">Phone Number</label>
										<input type="text" name="updatePhone" class="form-control" value="<?php echo $row["memberPhone"];?>">
									</div>
								</div>
								<div class="row form-group">
									<div class="col-md-4">
										<label for="subject">Password</label>
										<input type="password" name="updatePassword" class="form-control" value="<?php echo $row["memberPassword"];?>">
									</div>
								</div>
	...
	<script type="text/javascript">
	    ...
	    function validateForm() {
			...
			var email = document.updateForm.updateEmail.value;				
			var phone = document.updateForm.updatePhone.value;
			var password = document.updateForm.updatePassword.value;
