  ...
  <!-- Facebook and Twitter integration -->
					...
					<div class="col-md-10 col-md-offset-1">
						<div class="product-detail-wrap">
							<div class="row">
								...
								<div class="col-md-7">
									<form name="updateDraftGameForm" action="adminDraftUpdateGameProcess.php?cartStatus=1" method="post" enctype="multipart/form-data">
									<div class="desc">								
										<h4>Game Name</h4>
										...
										<div class="col-md-4">
	                                    	...
	                                    	<p>*JPG Only</p> 
	                                    	<b><input type="checkbox" id="statusChoice" name="gameStatus" value="1">&nbsp;Finalise Product</b>
	                                 		</div>
                        				</div>
										</div>
	...
	<script type="text/javascript">
		...
		function checkStatus() {
			var name = document.updateDraftGameForm.gameName.value;
			var price = document.updateDraftGameForm.gamePrice.value;
			var platform = document.updateDraftGameForm.gamePlatform.value;
			var desc = document.updateDraftGameForm.gameDesc.value;
			var cover = document.updateDraftGameForm.coverUpload;
			var thumb1 = document.updateDraftGameForm.thumbnailUpload1;
			var thumb2 = document.updateDraftGameForm.thumbnailUpload2;
			var thumb3 = document.updateDraftGameForm.thumbnailUpload3;
			var status = document.updateDraftGameForm.gameStatus;
