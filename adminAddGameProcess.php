...
<body>		
	<?php
		...
		$sql = "INSERT INTO product(prodName, prodDesc, prodPrice, prodPlatform, prodStatus) VALUES ('$gameName', '$gameDesc', '$gamePrice', '$gamePlatform', '$gameStatus')";		
		...
		// Images Section
		$sql2 = "SELECT prodID FROM product ORDER BY prodID DESC LIMIT 1";		
		...
		echo "<script>";
			echo "alert('Game Added!')</script>";
		echo "</script>";	
		header("refresh:0.1; url=adminAddGame.php");			
	?>	
</body>
</html>