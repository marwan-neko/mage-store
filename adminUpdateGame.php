  ...
  <!-- Facebook and Twitter integration -->
					...
					<div class="col-md-10 col-md-offset-1">
						<div class="product-detail-wrap">
							<div class="row">
								...
								<div class="col-md-7">
									<form name="updateGameForm" action="adminUpdateGameProcess.php?cartStatus=1" method="post" enctype="multipart/form-data">
									<div class="desc">								
										<h4>Game Name</h4>
										...
										<div class="col-md-4">
	                                    	...
	                                    	<input type="file" id="coverUpload" name="coverUpload" accept="image/jpg">
	                                    	<p>*JPG Only</p> 
	                                 		</div>
	...
	<script type="text/javascript">
		...
		function checkStatus() {
			var name = document.updateGameForm.gameName.value;
			var price = document.updateGameForm.gamePrice.value;
			var platform = document.updateGameForm.gamePlatform.value;
			var desc = document.updateGameForm.gameDesc.value;			
